...
describe("OrderBook", () => {
    let orderBook;
    beforeEach(() => {
        orderBook = new orderbook_1.OrderBook();
    });
    const createOrder = (id, type, price, quantity, timestamp = Date.now()) => {
    ...
    describe("market orders", () => {
        it("should execute market buy against best sell", () => {
            ...
            const bestAsk = orderBook.getBestAsk();
            // Assert
            expect(bestAsk === null || bestAsk === void 0 ? void 0 : bestAsk.quantity).toBe(2);
        });
        it("should execute market sell against best buy", () => {
            ...
            const bestBid = orderBook.getBestBid();
            // Assert
            expect(bestBid === null || bestBid === void 0 ? void 0 : bestBid.quantity).toBe(2);
        });
    });
    describe("limit order matching", () => {
        ...
        it("should partially match sell limit order and retain remainder", () => {
            ...
            const bestAsk = orderBook.getBestAsk();
            // Assert
            expect(bestAsk === null || bestAsk === void 0 ? void 0 : bestAsk.quantity).toBe(3);
        });
    });
